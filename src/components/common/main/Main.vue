<template>
  ...
  <div class="container">
    <ul class="list_case">
        ...
        <div class="dt">起重机自动焊接机械手(松下)</div>
        </a></li>
    </ul>
  </div>
...
<script>
import MainPages from './MainPages.vue'
export default {
  name: '',
  components: {
    MainPages
